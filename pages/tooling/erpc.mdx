## Abstract RPC Proxy and Caching
...
projects:
  - id: main
    upstreams:
      # You don't need to define architecture (e.g. evm) or chain id (e.g. 11124)
      # as they will be detected automatically by eRPC.
      - endpoint: https://abstract-testnet.public.blastapi.io
      - endpoint: https://api.testnet.abs.xyz
```
...
```bash
curl --location 'http://localhost:4000/main/evm/11124' \
