...
Abstract offers multiple Hardhat plugins with different features.
...
const config: HardhatUserConfig = {
  networks: {
    ...
    abstractTestnet: {
      url: "%%abs_testnet_rpc_url%%",
      ethNetwork: "%%abs_testnet_identifier%%",
      zksync: true,
    },
  },
...
networks: {
    ...
    abstractTestnet: {
      url: "%%zk_testnet_rpc_url%%", // The testnet RPC URL of Abstract network.
...
Verify your contracts programmatically using the `Hardhat verify plugin`.
