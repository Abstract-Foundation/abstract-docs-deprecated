...
Abstract scales Ethereum by moving computation off-chain and verifying batches of transactions through ZK proofs.
This allows Abstract to scale Ethereum while still inheriting its security properties, including censorship resistance and liveness guarantees.
