...
Once you've received your Sepolia Ether, you can bridge it to Abstract using our [native bridge](https://portal.testnet.abs.xyz/bridge/) or [third-party bridge](https://testnets.relay.link/abstract). you can find more details about the difference between native bridge and third-party bridge on [bridge](https://docs.abs.xyz/tools_integrations/bridge).
